...
tests/test_sycl_kernels.o: tests/test_sycl_kernels.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_kernels: tests/test_sycl_kernels.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-kernels: tests/test_sycl_kernels
	./tests/test_sycl_kernels
