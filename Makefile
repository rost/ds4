...
tests/test_sycl_output: tests/test_sycl_output.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-output: tests/test_sycl_output
	./tests/test_sycl_output

tests/test_sycl_embedding.o: tests/test_sycl_embedding.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_embedding: tests/test_sycl_embedding.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-embedding: tests/test_sycl_embedding
	./tests/test_sycl_embedding

tests/test_sycl_norm_rope.o: tests/test_sycl_norm_rope.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_norm_rope: tests/test_sycl_norm_rope.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-norm-rope: tests/test_sycl_norm_rope
	./tests/test_sycl_norm_rope

tests/test_sycl_compressor.o: tests/test_sycl_compressor.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_compressor: tests/test_sycl_compressor.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-compressor: tests/test_sycl_compressor
	./tests/test_sycl_compressor

tests/test_sycl_matmul.o: tests/test_sycl_matmul.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_matmul: tests/test_sycl_matmul.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-matmul: tests/test_sycl_matmul
	./tests/test_sycl_matmul

test-sycl: test-sycl-smoke test-sycl-gemm-batch-smoke test-sycl-session-smoke test-sycl-output test-sycl-embedding test-sycl-norm-rope test-sycl-compressor test-sycl-matmul test-sycl-streaming test-sycl-router test-sycl-fp8-kv test-sycl-shared-expert test-sycl-moe test-sycl-hc test-sycl-mgpu test-sycl-indexer test-sycl-attention test-sycl-attention-output test-sycl-engine-streaming-mgpu test-sycl-readback test-sycl-subgroup-guard test-sycl-full-layer test-sycl-full-token test-sycl-prefill-batch test-sycl-gguf-load test-sycl-placement test-sycl-model-cache
tests/test_sycl_shared_expert.o: tests/test_sycl_shared_expert.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_shared_expert: tests/test_sycl_shared_expert.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-shared-expert: tests/test_sycl_shared_expert
	./tests/test_sycl_shared_expert


tests/test_sycl_streaming.o: tests/test_sycl_streaming.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_streaming: tests/test_sycl_streaming.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-streaming: tests/test_sycl_streaming
	./tests/test_sycl_streaming

tests/test_sycl_router.o: tests/test_sycl_router.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_router: tests/test_sycl_router.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-router: tests/test_sycl_router
	./tests/test_sycl_router

tests/test_sycl_subgroup_guard.o: tests/test_sycl_subgroup_guard.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_subgroup_guard: tests/test_sycl_subgroup_guard.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-subgroup-guard: tests/test_sycl_subgroup_guard
	./tests/test_sycl_subgroup_guard

tests/test_sycl_fp8_kv.o: tests/test_sycl_fp8_kv.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_fp8_kv: tests/test_sycl_fp8_kv.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-fp8-kv: tests/test_sycl_fp8_kv
	./tests/test_sycl_fp8_kv
tests/test_sycl_moe.o: tests/test_sycl_moe.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_moe: tests/test_sycl_moe.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm
...
test-sycl-mgpu: tests/test_sycl_mgpu
	./tests/test_sycl_mgpu

# ds4_sycl_test_hooks.o compiles ds4.c itself with DS4_TEST_HOOKS defined,
# exposing metal_graph_alloc_raw_cap (the real session-graph allocator)
...
tests/test_sycl_session_smoke: tests/test_sycl_session_smoke.o ds4_sycl_test_hooks.o ds4_sycl.o ds4_sycl_unavailable.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm
...
tests/test_sycl_full_token.o: tests/test_sycl_full_token.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_layer_weights.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_full_token: tests/test_sycl_full_token.o ds4_sycl_test_hooks.o ds4_sycl.o ds4_sycl_unavailable.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-full-token: tests/test_sycl_full_token
	./tests/test_sycl_full_token

tests/test_sycl_prefill_batch.o: tests/test_sycl_prefill_batch.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_layer_weights.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_prefill_batch: tests/test_sycl_prefill_batch.o ds4_sycl_test_hooks.o ds4_sycl.o ds4_sycl_unavailable.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-prefill-batch: tests/test_sycl_prefill_batch
	./tests/test_sycl_prefill_batch

tests/test_sycl_gguf_load.o: tests/test_sycl_gguf_load.c ds4.h ds4_gpu.h tests/test_sycl_layer_weights.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_gguf_load: tests/test_sycl_gguf_load.o ds4_sycl_test_hooks.o ds4_sycl.o ds4_sycl_unavailable.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-gguf-load: tests/test_sycl_gguf_load
	./tests/test_sycl_gguf_load
...
tests/test_sycl_engine_streaming_mgpu: tests/test_sycl_engine_streaming_mgpu.o ds4_sycl_test_hooks.o ds4_sycl.o ds4_sycl_unavailable.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-engine-streaming-mgpu: tests/test_sycl_engine_streaming_mgpu
	./tests/test_sycl_engine_streaming_mgpu
...
tests/test_sycl_indexer.o: tests/test_sycl_indexer.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_indexer: tests/test_sycl_indexer.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-indexer: tests/test_sycl_indexer
	./tests/test_sycl_indexer

tests/test_sycl_attention.o: tests/test_sycl_attention.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_attention: tests/test_sycl_attention.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-attention: tests/test_sycl_attention
	./tests/test_sycl_attention
tests/test_sycl_attention_output.o: tests/test_sycl_attention_output.c ds4_gpu.h ds4_gpu_mgpu.h tests/test_sycl_harness.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_attention_output: tests/test_sycl_attention_output.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm
...
# Needs ds4_sycl_test_hooks.o (ds4.c under DS4_TEST_HOOKS) to drive
# ds4_test_classify_multi_tier, the same hook tests/test_engine_mgpu_
...
test-sycl-placement: tests/test_sycl_placement
	./tests/test_sycl_placement

# The device-resident model-weight cache: ds4_gpu_cache_model_range
# and the sycl_model_range_ptr lookup it feeds (sycl/ds4_sycl_model_cache.hpp).
# Needs no DS4_TEST_HOOKS compile of ds4.c: every entry this test calls
# (ds4_gpu_cache_model_range, ds4_gpu_tier_free_vram, the test-only cache
# hooks) lives in ds4_sycl.o, the same lean link tests/test_sycl_router.c
# uses.
tests/test_sycl_model_cache.o: tests/test_sycl_model_cache.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) $(SYCL_HOST_CFLAGS) -DDS4_SYCL_BUILD -I. -c -o $@ $<

tests/test_sycl_model_cache: tests/test_sycl_model_cache.o ds4_sycl.o ds4_sycl_unavailable.o
	$(ICPX) $(SYCL_CFLAGS) -o $@ $^ $(SYCL_LDLIBS) -lm

test-sycl-model-cache: tests/test_sycl_model_cache
	./tests/test_sycl_model_cache
